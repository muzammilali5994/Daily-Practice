...
// function editData(){
//     let name = document.querySelector(".name-cell").innerText;
//     let lastName = document.querySelector(".last-name-cell").innerText;
...
function submitData() {
  ...
  if (editRow === null) {
    ...
    // UPDATE DATA
    editRow.querySelector(".name-cell").innerText = name;
    editRow.querySelector(".last-name-cell").innerText = lastName;
    editRow = null;
  }
...
function editData(btn) {
  ...
  document.getElementById("name").value =
    editRow.querySelector(".name-cell").innerText;

  document.getElementById("lastName").value =
    editRow.querySelector(".last-name-cell").innerText;
}
function deleteData(btn) {
  btn.closest("tr").remove();
}
let arr = []; let editIndex = null; function submitData(){ let name = document.getElementById("name").value; let lastName = document.getElementById("lastName").value; if(editIndex === null){ arr.push({ name, lastName }); } else { arr[editIndex].name = name; arr[editIndex].lastName = lastName; editIndex = null; } saveTable(); clearField(); } function saveTable(){ let table = document.getElementById("table"); table.innerHTML = ""; arr.forEach((item,index)=>{ table.innerHTML += <tr> <td>${item.name}</td> <td>${item.lastName}</td> <td><button onclick="editData(${index})">Edit</button></td> <td><button onclick="deleteData(${index})">Delete</button></td> </tr> ; }); } function clearField(){ document.getElementById("name").value = ""; document.getElementById("lastName").value = ""; } is code may or mary nechy waly code may kia difference hay let arr = []; let editIndex = null; function submitData(){ let name = document.getElementById("name").value; let lastName = document.getElementById("lastName").value; if(editIndex === null) { arr.push=({name,lastName}); } else{ arr[editIndex].name = name; arr[editIndex].lastName = lastName; editIndex = null; } saveTable(); //saveStorage(); clearField(); } function saveTable(){ let table = document.getElementById("table"); table.innerHTML = ""; arr.forEach((item,index)=>{ table.innerHTML += <tr> <td>${item.name}</td> <td>${item.lastName}</td> <td><button onclick="editData(${index})">Edit</button></td> <td><button onclick="deleteData(${index})">Delete</button></td> </tr> ; }); } function clearField(){ document.getElementById("name").value =""; document.getElementById("lastName").value =""; }
